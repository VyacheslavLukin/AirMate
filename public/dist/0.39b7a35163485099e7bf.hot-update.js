  ...
  (0, _createClass3.default)(IndexPage, [{
    ...
    value: function componentDidMount() {
      ...
      data.forEach(function (item) {
        L.marker([item.longitude, item.latitude]).addTo(_this2.map).bindPopup("\u0428\u0438\u0440\u043E\u0442\u0430: " + item.latitude + "<br>\u0414\u043E\u043B\u0433\u043E\u0442\u0430: " + item.longitude + "<br>\u0425\u044D\u0448 \u0442\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u0438: " + item.data.transaction);
      });
