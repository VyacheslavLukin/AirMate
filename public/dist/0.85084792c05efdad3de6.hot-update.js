    ...
    value: function componentWillMount() {
      ...
      this.geoJSONLayer = L.geoJSON(this.state.modelPoints, {
        style: function style(feature) {
          ...
          var return_value = rgb && rgb.length === 4 ? "#0" + parseInt(rgb[1], 10).toString(16).slice(-2) + "0" + parseInt(rgb[2], 10).toString(16).slice(-2) + "0" + parseInt(rgb[3], 10).toString(16).slice(-2) + "}" : "";
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { id: "leaflet-buttons-wrapper" },
          _react2.default.createElement("input", {
            type: "button",
            className: rawDataClass,
            value: rawDataValue,
            onClick: function onClick() {
              _this4.toggleButton("showRawData");
            }
          }),
          _react2.default.createElement("input", {
            type: "button",
            className: modelDataClass,
            value: modelDataValue,
            onClick: function onClick() {
              _this4.toggleButton("showModelData");
            }
          })
        )
      );
