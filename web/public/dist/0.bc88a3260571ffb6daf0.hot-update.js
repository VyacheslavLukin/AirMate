...
var IndexPage = function (_React$Component) {
  ...
  (0, _createClass3.default)(IndexPage, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _Api.makeApiGet)('http://localhost:5000/get_sensors_list').then(function (data) {
        ...
        data.forEach(function (item) {
          L.marker([item.latitude, item.longitude]).addTo(_this2.map);
          // .bindPopup(
        ...
        _this2.map.on('click', _this2.onMapClick);
      });
    ...
    value: function onMapClick(e) {
      this.popup.setLatLng(e.latlng).setContent("You clicked the map at " + e.latlng.toString()).openOn(this.map);
    }
  }, {
