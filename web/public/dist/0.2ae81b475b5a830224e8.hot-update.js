  ...
  (0, _createClass3.default)(IndexPage, [{
    ...
    value: function onMapClick(e) {
      ...
      (0, _Api.makeApiGet)("http://localhost:5000/get_sensor_data/" + currentItem.id).then(function (data) {
        _this3.map = new L.Map("map", {
          zoomControl: false,
          center: new L.LatLng(data[0].latitude, data[0].longitude),
          zoom: 10,
          layers: [_this3.baseLayer, _this3.heatmapLayer, _this3.geoJSONLayer]
        });

        var dataToSave = {};

        data.forEach(function (item) {
          var temp = L.marker([item.latitude, item.longitude]).addTo(_this3.map).on('click', _this3.onMapClick);
      ...
      this.popup.setLatLng(e.target._latlng).setContent("ID: " + currentItem.id + "<br>\n\u0428\u0438\u0440\u043E\u0442\u0430: " + currentItem.latitude + "<br>\n\u0414\u043E\u043B\u0433\u043E\u0442\u0430: " + currentItem.longitude + "<br>").openOn(this.map);
    }
  }, {
