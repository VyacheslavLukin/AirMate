...
var IndexPage = function (_React$Component) {
  ...
  (0, _createClass3.default)(IndexPage, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _Api.makeApiGet)('http://localhost:5000/get_sensors_list').then(function (data) {
        ...
        data.forEach(function (item) {
          L.marker([item.latitude, item.longitude]).addTo(_this2.map).on('click', _this2.onMapClick);
        });
    ...
    value: function onMapClick(e) {
      console.log(e);
      this.popup.setLatLng(e.target.latlng).setContent("\u0428\u0438\u0440\u043E\u0442\u0430: " + item.latitude + "<br>\u0414\u043E\u043B\u0433\u043E\u0442\u0430: " + item.longitude + "<br>").openOn(this.map);
    }
  }, {
